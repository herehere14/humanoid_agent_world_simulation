# Optimizer Restructure Targeted Probe

## Aggregate

- full_adaptive: train=0.7550, holdout=0.7550, delta_vs_frozen=-0.0250
- frozen: train=0.7488, holdout=0.7800
- memory_only: train=0.7550, holdout=0.7800, delta_vs_frozen=+0.0000
- weight_only: train=0.7612, holdout=0.7550, delta_vs_frozen=-0.0250

## Optimizer Summary

- full_adaptive: updates=8/8, allowed=5, max_branches_per_event=1, mean_total_delta=0.0044
...
- weight_only: updates=8/8, allowed=5, max_branches_per_event=1, mean_total_delta=0.0046
